...
namespace Focela\Laratrust\Tests\Users;
...
class IlluminateUserRepositoryTest extends TestCase
{
    ...
    {
        $users = m::mock('Focela\Laratrust\Users\IlluminateUserRepository[createModel,findById]', [
    ...
    {
        return m::mock('Focela\Laratrust\Users\EloquentUser');
    }
    ...
    protected function setUp(): void
    {
        ...
        $this->model = m::mock('Focela\Laratrust\Users\EloquentUser');
        $this->model->shouldReceive('newQuery')->andReturn($this->query);

        $this->users = m::mock('Focela\Laratrust\Users\IlluminateUserRepository[createModel]', [
            $this->hasher,
        ]);
