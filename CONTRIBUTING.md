...
```bash
git clone git@github.com:your_github_username/laratrust.git
cd laratrust
git remote add upstream https://github.com/focela/laratrust.git
git fetch upstream
```
...
[fork]: https://github.com/focela/laratrust/fork

[open-issue]: https://github.com/focela/laratrust/issues/new

[cla]: https://cla-assistant.io/focela/laratrust
